/*
 * Enhanced JDO class Savings.java
 *
 */
...
/**
*  Enhanced Class Description for Savings.java
*
...
public class Savings 
            extends Account implements Serializable, PersistenceCapable, InstanceCallbacks    
{
    /////////////////////////////////////////////////////////////
    // The Original Savings User's Class Contents
    /////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////
		...
		this._setAccountType_(SAVINGS_ACCOUNT_);
    ///////////////////////////////////////////
    ...
    ///////////////////////////////////////////
		...
		if(this._getAccountType_() != SAVINGS_ACCOUNT_) { throw new Exception("Invalid Account Type :"+this._getAccountType_());
    }

		return this._getBalance_()*this._getInterestRate_()/100;
    ///////////////////////////////////////////
    ////   End of User's Business Logic    ////
    ///////////////////////////////////////////
    }
    ...
    {
        Savings.jdoSetCom_Hywy_Samples_Bank_Savings_interestRate_(this, newInterestRate_ );
    }
    
    /** Accessor Method for field --> interestRate_ */ 
    public int  getInterestRate_(  )     
    {
        return Savings.jdoGetCom_Hywy_Samples_Bank_Savings_interestRate_(this);
    }
    ...
    strBuff.append(" Savings: ");
		...
		strBuff.append(" interestRate_= " + this._getInterestRate_());
    ...
    /////////////////////////////////////////////////////////////////
    /**
     * Savings has 1 persistentcapable fields
     */
    ...
    /////////////////////////////////////////////////////////////////
    /**
     * Savings's JDO identity is datastore 
    ...
    /////////////////////////////////////////////////////////////////
    /**
     * 4 persistentcapable fields are defined in the super class: com.hywy.samples.bank.Account.class
     * 1 persistentcapable fields are defined in the class: Savings.class
     */
     private static String[] jdoFieldNames = new String[]  { "accountType_","balance_","customerNames_","interestRate_","openedOn_" };
 
    /**
     *  5   persistentcapable field type
     */
     private static Class[] jdoFieldTypes = new Class[] {   int.class,  int.class,  java.lang.String.class,  int.class,  java.util.Date.class };

    /**
     *  5   persistentcapable fields are defined in the class: Savings.class
     */
     private static byte[] jdoFieldFlags = new byte[] {  CHECK_READ+CHECK_WRITE, CHECK_READ+CHECK_WRITE, CHECK_READ+CHECK_WRITE, CHECK_READ+CHECK_WRITE, CHECK_READ+CHECK_WRITE };
    ...
    static
    {
                com.hywy.samples.bank.Account.class.getName();
    ...
    public PersistenceCapable jdoNewInstance(StateManager stateManager)
    {
        ...
        /////////////////////////////////////////////////////////////////
        Savings _jdoInstance_ = new Savings();
    ...
    public void jdoProvideField(int fieldNumber)
    {
        ...
        switch (fieldNumber)
        {
            ...
            case 3:
                jdoStateManager.providedIntField(this, fieldNumber, _getInterestRate_2());
                break;
    ...
    public void jdoReplaceField(int fieldNumber)
    {
        ...
        switch (fieldNumber)
        {
            ...
            case 3:
                _setInterestRate_2 ( jdoStateManager.replacingIntField(this, fieldNumber) );
                break;
    ...
    public void jdoCopyFields (Object persistenceCapable, int[] fieldNumbers)
    {
        ...
        if (persistenceCapable instanceof Savings) 
        {
            Savings other = (Savings)persistenceCapable;
     ...
     *
     */
    public void jdoCopyField (Savings other, int fieldNumber)
    {
        final String THIS = "jdoCopyField(other,fieldNumber): ";
            switch (fieldNumber)
            {
                ...
                case 3:
                    _setInterestRate_2 (other._getInterestRate_());
                    break;
     ...
     *
     */
    public static int jdoGetCom_Hywy_Samples_Bank_Savings_accountType_(Savings _jdoInstance_)
    {
        return jdoGetCom_Hywy_Samples_Bank_Savings__accountType_( _jdoInstance_ );	
    }
     ...
     *
     */
    public static void jdoSetCom_Hywy_Samples_Bank_Savings_accountType_(Savings _jdoInstance_, int newValue)
    {
        jdoSetCom_Hywy_Samples_Bank_Savings__accountType_( _jdoInstance_, newValue);
    }
     ...
     *
     */
    public static int jdoGetCom_Hywy_Samples_Bank_Savings__accountType_(Savings _jdoInstance_)
    {
        ...
        {
            return ((Savings)_jdoInstance_)._getAccountType_2();
        }
    }
     ...
     *
     */
    public static void jdoSetCom_Hywy_Samples_Bank_Savings__accountType_(Savings _jdoInstance_, int newValue)
    {
        // default fetch group field
        if( _jdoInstance_.jdoFlags == READ_WRITE_OK )
        {
    ...
    {
            return Savings.jdoGetCom_Hywy_Samples_Bank_Savings__accountType_(this);
    }
    ...
    {
        Savings.jdoSetCom_Hywy_Samples_Bank_Savings__accountType_(this, newValue);
    }
    ...
    {
        super._setAccountType_2 (newValue);
    }
     ...
     *
     */
    public static int jdoGetCom_Hywy_Samples_Bank_Savings_balance_(Savings _jdoInstance_)
    {
        return jdoGetCom_Hywy_Samples_Bank_Savings__balance_( _jdoInstance_ );	
    }
     ...
     *
     */
    public static void jdoSetCom_Hywy_Samples_Bank_Savings_balance_(Savings _jdoInstance_, int newValue)
    {
        jdoSetCom_Hywy_Samples_Bank_Savings__balance_( _jdoInstance_, newValue);
    }
     ...
     *
     */
    public static int jdoGetCom_Hywy_Samples_Bank_Savings__balance_(Savings _jdoInstance_)
    {
        // default fetch group field
        if( _jdoInstance_.jdoFlags <= READ_WRITE_OK )
        {
        ...
        {
            return ((Savings)_jdoInstance_)._getBalance_2();
        }
    }
     ...
     *
     */
    public static void jdoSetCom_Hywy_Samples_Bank_Savings__balance_(Savings _jdoInstance_, int newValue)
    {
        // default fetch group field
        if( _jdoInstance_.jdoFlags == READ_WRITE_OK )
        {
    ...
    {
            return Savings.jdoGetCom_Hywy_Samples_Bank_Savings__balance_(this);
    }
    ...
    {
        Savings.jdoSetCom_Hywy_Samples_Bank_Savings__balance_(this, newValue);
    }
     ...
     *
     */
    public static java.lang.String jdoGetCom_Hywy_Samples_Bank_Savings_customerNames_(Savings _jdoInstance_)
    {
        return jdoGetCom_Hywy_Samples_Bank_Savings__customerNames_( _jdoInstance_ );	
    }
     ...
     *
     */
    public static void jdoSetCom_Hywy_Samples_Bank_Savings_customerNames_(Savings _jdoInstance_, java.lang.String newValue)
    {
        jdoSetCom_Hywy_Samples_Bank_Savings__customerNames_( _jdoInstance_, newValue);
    }
     ...
     *
     */
    public static java.lang.String jdoGetCom_Hywy_Samples_Bank_Savings__customerNames_(Savings _jdoInstance_)
    {
        // default fetch group field
        if( _jdoInstance_.jdoFlags <= READ_WRITE_OK )
        {
        ...
        {
            return ((Savings)_jdoInstance_)._getCustomerNames_2();
        }
    }
     ...
     *
     */
    public static void jdoSetCom_Hywy_Samples_Bank_Savings__customerNames_(Savings _jdoInstance_, java.lang.String newValue)
    {
        // default fetch group field
        if( _jdoInstance_.jdoFlags == READ_WRITE_OK )
        {
    ...
    {
            return Savings.jdoGetCom_Hywy_Samples_Bank_Savings__customerNames_(this);
    }
    ...
    {
        Savings.jdoSetCom_Hywy_Samples_Bank_Savings__customerNames_(this, newValue);
    }
    ...
    {
        super._setCustomerNames_2 (newValue);
    }
     ...
     *
     */
    public static int jdoGetCom_Hywy_Samples_Bank_Savings_interestRate_(Savings _jdoInstance_)
    {
        return jdoGetCom_Hywy_Samples_Bank_Savings__interestRate_( _jdoInstance_ );	
    }
     ...
     *
     */
    public static void jdoSetCom_Hywy_Samples_Bank_Savings_interestRate_(Savings _jdoInstance_, int newValue)
    {
        jdoSetCom_Hywy_Samples_Bank_Savings__interestRate_( _jdoInstance_, newValue);
    }
     ...
     *
     */
    public static int jdoGetCom_Hywy_Samples_Bank_Savings__interestRate_(Savings _jdoInstance_)
    {
        // default fetch group field
        if( _jdoInstance_.jdoFlags <= READ_WRITE_OK )
        {
            return _jdoInstance_._getInterestRate_2();
        }
        StateManager stateManager = _jdoInstance_.jdoStateManager;
        if (stateManager != null)
        {
            ...
            return stateManager.getIntField (_jdoInstance_, fieldNumber, _jdoInstance_._getInterestRate_2());
        }
        else
        {
            return ((Savings)_jdoInstance_)._getInterestRate_2();
        }
    }
     ...
     *
     */
    public static void jdoSetCom_Hywy_Samples_Bank_Savings__interestRate_(Savings _jdoInstance_, int newValue)
    {
        // default fetch group field
        if( _jdoInstance_.jdoFlags == READ_WRITE_OK )
        {
            _jdoInstance_._setInterestRate_2 (newValue);
            return;
        }
        StateManager stateManager = _jdoInstance_.jdoStateManager;
        if (stateManager == null)
        ...
        {
            int fieldNumber = _jdoInstance_.jdoInheritedFieldCount + 3;
            stateManager.setIntField (_jdoInstance_, fieldNumber, _jdoInstance_._getInterestRate_(), newValue);
        }
    }
    ...
    {
            return Savings.jdoGetCom_Hywy_Samples_Bank_Savings__interestRate_(this);
    }
     ...
     *
     */
    public void _setInterestRate_ (int  newValue)
    {
        Savings.jdoSetCom_Hywy_Samples_Bank_Savings__interestRate_(this, newValue);
    }
     ...
     *
     */
    public void _setInterestRate_2 (int  newValue)
    {
        interestRate_ = newValue;
    }
     ...
     *
     */
    public static java.util.Date jdoGetCom_Hywy_Samples_Bank_Savings_openedOn_(Savings _jdoInstance_)
    {
        return jdoGetCom_Hywy_Samples_Bank_Savings__openedOn_( _jdoInstance_ );	
    }
     ...
     *
     */
    public static void jdoSetCom_Hywy_Samples_Bank_Savings_openedOn_(Savings _jdoInstance_, java.util.Date newValue)
    {
        jdoSetCom_Hywy_Samples_Bank_Savings__openedOn_( _jdoInstance_, newValue);
    }
     ...
     *
     */
    public static java.util.Date jdoGetCom_Hywy_Samples_Bank_Savings__openedOn_(Savings _jdoInstance_)
    {
        // default fetch group field
        if( _jdoInstance_.jdoFlags <= READ_WRITE_OK )
        {
        ...
        if (stateManager != null)
        {
            int fieldNumber = _jdoInstance_.jdoInheritedFieldCount + 4;
            if (stateManager.isLoaded (_jdoInstance_, fieldNumber))
            {
                return _jdoInstance_._getOpenedOn_2();
            }
        ...
        {
            return ((Savings)_jdoInstance_)._getOpenedOn_2();
        }
    }
     ...
     *
     */
    public static void jdoSetCom_Hywy_Samples_Bank_Savings__openedOn_(Savings _jdoInstance_, java.util.Date newValue)
    {
        // default fetch group field
        if( _jdoInstance_.jdoFlags == READ_WRITE_OK )
        {
    ...
    {
            return Savings.jdoGetCom_Hywy_Samples_Bank_Savings__openedOn_(this);
    }
    ...
    {
        Savings.jdoSetCom_Hywy_Samples_Bank_Savings__openedOn_(this, newValue);
    }
...
}  // end of enhanced JDO class -> Savings.java