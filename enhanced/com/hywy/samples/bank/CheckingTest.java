/*
 * JUnit Test class CheckingTest.java for com.hywy.samples.bank.Checking.java
 *
 */
...
/**
 * Unit test associated with com.hywy.samples.bank.Checking Class' JDO field's get/set method Implementation
 ...
 *
 */
public class CheckingTest extends junit.framework.TestCase {
	...
	*/
	...
	/**
	*/
	public CheckingTest (String name) {
		super (name);
	}
	...
	*/
	protected void setUp() {
		...
		Throwable th = null;
		adapter_ = new JDOAdapter(CheckingTest.PROJECT_NAME_,
				      	  CheckingTest.INITIAL_POOL_CAPACITY_,
				          CheckingTest.MAXIMUM_POOL_CAPACITY_,
				          CheckingTest.POOL_CAPACITY_INCREMENT_);
		
		try{
	        	pmFactory_ = this.getAdapter().obtainPMF(CheckingTest.PROJECT_NAME_,
                                                 	CheckingTest.DATASTORE_NAME_);				          
	...
	*/
	public static junit.framework.Test suite() {
		return new junit.framework.TestSuite(com.hywy.samples.bank.CheckingTest.class);
	}
	...
	*/
	public static void main(String args[]) {
		...
		//  junit.awtui.TestRunner.run(com.hywy.samples.bank.CheckingTest.class);
		///////////////////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////////////////////		
		// The CheckingTest class is run in the command line by default.	
		////////////////////////////////////////////////////////////////////////////
		
		// Run the test harness
		junit.textui.TestRunner.run(com.hywy.samples.bank.CheckingTest.class);
	...
	*/
	public void testSetGetAccountType_() {
		...
		checking.setAccountType_(accountType_);				
		assertEquals(" 1 - Before make persistence while comparing accountType_ -> ", accountType_, checking.getAccountType_());
		...
		try {
			...
			pManager.makePersistent(checking);

			// Commit the transaction
			transaction.commit();

			assertEquals(" 2 - After make persistence while comparing accountType_ -> ", accountType_, checking.getAccountType_());
	...
	*/
	public void testSetGetBalance_() {
		...
		checking.setBalance_(balance_);				
		assertEquals(" 1 - Before make persistence while comparing balance_ -> ", balance_, checking.getBalance_());
		...
		try {
			...
			assertEquals(" 2 - After make persistence while comparing balance_ -> ", balance_, checking.getBalance_());
	...
	*/
	public void testSetGetCustomerNames_() {
		...
		checking.setCustomerNames_(customerNames_);				
		assertEquals(" 1 - Before make persistence while comparing customerNames_ -> ", customerNames_, checking.getCustomerNames_());
		...
		try {
			...
			assertEquals(" 2 - After make persistence while comparing customerNames_ -> ", customerNames_, checking.getCustomerNames_());
	...
	*/
	public void testSetGetOpenedOn_() {
		...
		checking.setOpenedOn_(openedOn_);				
		assertEquals(" 1 - Before make persistence while comparing openedOn_ -> ", openedOn_, checking.getOpenedOn_());
		...
		try {
			...
			assertEquals(" 2 - After make persistence while comparing openedOn_ -> ", openedOn_, checking.getOpenedOn_());
